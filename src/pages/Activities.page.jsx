      ...
      <div className="container mx-auto px-4">
        <div className="w-full lg:flex lg:flex-row-reverse">
          <div className="lg:w-3/4">
            <h2 className="text-2xl font-bold mb-4">Activities in Pune</h2>
            <div className="flex flex-wrap lg:mr-20">
              ...
              <div className="w-1/2 md:w-1/3 lg:w-3/12 my-3">
                <Posterplay
                  src="https://in.bmscdn.com/discovery-catalog/events/tr:w-400,h-600,bg-CCCCCC:w-400.0,h-660.0,cm-pad_resize,bg-000000,fo-top:ote-U3VuLCAxIEF1ZyBvbndhcmRz,ots-29,otc-FFFFFF,oy-612,ox-24/et00312639-kmlsyhumnu-portrait.jpg"
